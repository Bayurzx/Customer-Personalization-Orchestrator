...
def execute_notebook(notebook_path):
    ...
    cmd = ["jupyter", "nbconvert", "--to", "notebook", "--execute", "--inplace", str(notebook_path)]
...
def convert_html_to_pdf(html_path, pdf_path):
    ...
    try:
        ...
        html_doc.write_pdf(str(pdf_path), stylesheets=[css], optimize_images=True)
...
def main():
    ...
    parser.add_argument("--output", default="reports/experiment_report.pdf", help="Output PDF path")
    parser.add_argument("--skip-validation", action="store_true", help="Skip PDF validation")
    parser.add_argument(
        "--keep-html", action="store_true", help="Keep intermediate HTML file for debugging"
    )
