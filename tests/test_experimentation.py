...
class TestExperimentationAgent:
    ...
    def sample_config(self):
        ...
        return {
            "experiment": {"name": "test_experiment", "description": "Test A/B/n experiment"},
            ...
            "metrics": {"primary": "click_rate", "secondary": ["open_rate", "conversion_rate"]},
            "statistical_testing": {"alpha": 0.05, "test_type": "t_test"},
            "simulation": {
    ...
    def sample_customers(self):
        ...
        return [
            ...
            {"customer_id": "C003", "segment": "Standard", "features": {"avg_order_value": 150.0}},
            {"customer_id": "C004", "segment": "Standard", "features": {"avg_order_value": 120.0}},
            {
                "customer_id": "C005",
            ...
            {"customer_id": "C008", "segment": "Standard", "features": {"avg_order_value": 140.0}},
        ]
...
class TestConvenienceFunctions:
    ...
    def test_design_experiment_function(self, sample_config):
        ...
        variants = [{"variant_id": "V1", "segment": "Test", "tone": "urgent"}]
...
class TestEdgeCases:
    ...
    def test_statistical_significance_with_small_sample(self):
        ...
        control_data = {"sample_size": 5, "counts": {"opened": 1, "clicked": 0, "converted": 0}}
        treatment_data = {"sample_size": 5, "counts": {"opened": 2, "clicked": 1, "converted": 0}}
