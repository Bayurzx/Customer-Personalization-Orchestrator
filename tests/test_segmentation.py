...
def sample_customer_data():
    ...
    return pd.DataFrame({
        ...
        'purchase_frequency': [12, 8, 18, 2, 15, 7, 1],  # Adjusted to trigger different segments
        'avg_order_value': [250.0, 150.0, 300.0, 75.0, 320.0, 180.0, 50.0],  # Added high-value and low-value
    ...
    def test_high_value_recent_segment(self, sample_customer_data):
        ...
        if len(high_value_customers) > 0:
            ...
            for _, customer in high_value_customers.iterrows():
                ...
                orig_data = sample_customer_data[sample_customer_data['customer_id'] == customer_id].iloc[0]
...
class TestKMeansSegmentation:
    ...
    def test_cluster_name_generation(self, sample_customer_data):
        ...
        valid_segments = {"High-Value Recent", "At-Risk", "New Customer", "Standard", "Loyal Frequent"}
