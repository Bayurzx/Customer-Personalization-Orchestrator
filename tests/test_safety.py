...
class TestSafetyAgent:
    ...
    def test_generate_audit_report_with_data(self):
        ...
        with open(self.temp_audit_log.name, 'w', newline='') as f:
            ...
            # Write headers
            writer.writerow([
                'timestamp', 'variant_id', 'customer_id', 'segment', 'status',
                'hate_severity', 'violence_severity', 'self_harm_severity', 'sexual_severity',
                'max_severity', 'threshold_used', 'blocked_categories', 'block_reason'
            ])
            # Write sample data
            writer.writerow([
                '2025-11-23T10:00:00', 'VAR001', 'C001', 'Test', 'pass',
                0, 2, 0, 0, 2, 4, '', ''
            ])
            writer.writerow([
                '2025-11-23T10:01:00', 'VAR002', 'C002', 'Test', 'block',
                6, 0, 0, 0, 6, 4, 'hate', 'Hate severity above threshold'
            ])
