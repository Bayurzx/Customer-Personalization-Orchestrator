...
class TestDocumentIndexing:
    ...
    def test_index_documents_batch_processing(self, mock_get_client):
        ...
        documents = [{"document_id": f"DOC{i:03d}", "title": f"Test {i}"} for i in range(1, 8)]
...
class TestIntegrationOperations:
    ...
    def test_test_index_operations_success(
        self, mock_create, mock_exists, mock_index_docs, mock_stats, mock_delete
    ):
...
def sample_content_document():
    ...
    return {
        ...
        "metadata": {"author": "Marketing Team", "version": "1.2", "last_updated": "2025-10-15"},
    }
...
class TestRetrievalAgent:
    ...
    def test_construct_query_from_segment_high_value(self):
        ...
        segment = {
            ...
            "features": {"avg_order_value": 275.0, "avg_purchase_frequency": 14.5},
        }
    ...
    def test_construct_query_from_segment_at_risk(self):
        ...
        segment = {"name": "At-Risk", "features": {"engagement_score": 0.2}}
    ...
    def test_construct_query_from_segment_new_customer(self):
        ...
        segment = {"name": "New Customer", "features": {}}
        ...
        assert any(
            term in query.lower()
            for term in ["welcome", "getting started", "introduction", "new customer"]
        )
    ...
    def test_construct_query_fallback(self):
        ...
        segment = {"name": "Unknown Segment", "features": {}}
