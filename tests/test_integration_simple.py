...
class TestBasicIntegration:
    ...
    def test_experimentation_with_segments(self):
        ...
        assignments = exp_agent.assign_customers_to_arms(
            customers_with_segments.to_dict('records'),
            experiment
        )
        ...
        assert all('open_rate' in arm_metrics['metrics'] for arm_metrics in metrics['arms'].values())
    ...
    def test_end_to_end_pipeline_structure(self):
        ...
        total_customers = sum(arm_metrics['sample_size'] for arm_metrics in metrics['arms'].values())
