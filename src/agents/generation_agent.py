...
class MessageGenerator:
    ...
    def generate_variants(
        self, segment: Dict[str, Any], content: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
        """
    ...
    def generate_variant(
        self, segment: Dict[str, Any], content: List[Dict[str, Any]], tone: str
    ) -> Dict[str, Any]:
        """
    ...
    def extract_citations(self, body: str, content: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for match in matches:
            ...
            for doc in content:
                if (
                    doc.get("title", "").lower() in title_part.lower()
                    or title_part.lower() in doc.get("title", "").lower()
                ):
                    matched_doc = doc
                    break
    ...
    def _build_prompt(
        ...
        for i, doc in enumerate(content, 1):
            snippet_text = (
                f"{i}. [{doc.get('document_id')}] {doc.get('title')}:\n{doc.get('snippet')}"
            )
...
def generate_variants(
    segment: Dict[str, Any], content: List[Dict[str, Any]]
) -> List[Dict[str, Any]]:
    """
...
def generate_variant(
    segment: Dict[str, Any], content: List[Dict[str, Any]], tone: str
) -> Dict[str, Any]:
    """
